...
<xsl:output method="html" encoding="UTF-8" indent="yes" />
    <xsl:template match="/">
        <html>
            <head>
                ...
                <meta charset="UTF-8" />
                <link rel="stylesheet" type="text/css" href="definitivoCSS.css" />
                ...
                <script type="text/javascript" src="definitivoJS.js"></script>
            </head>
            <body>
                <h1 class='mainTitle'>
                    <xsl:value-of select="tei:teiCorpus/tei:teiHeader/tei:fileDesc/tei:titleStmt/tei:title" />
                ...
                <div class="descrizione">
                    <p> All'interno di questo progetto sono riportate le codifiche in formato digitale di alcune cartoline<br />redatte durante la <strong> Prima Guerra Mondiale </strong>, 
                    le quali si trovano attualmente presso<br /><xsl:value-of select="//tei:sourceDesc/tei:msDesc/tei:msIdentifier/tei:repository"/> 
                    (<xsl:value-of select="//tei:sourceDesc/tei:msDesc/tei:msIdentifier/tei:settlement"/>). <br/>
                ...
                <div class="elenco">     
                    <button class="menucartolina" id="c14"><xsl:value-of select="//tei:TEI[@xml:id='cart14']//tei:sourceDesc/tei:bibl/tei:title"/> </button>
                    <button class="menucartolina" id="c23"><xsl:value-of select="//tei:TEI[@xml:id='cart23']//tei:sourceDesc/tei:bibl/tei:title"/> </button>
                    <button class="menucartolina" id="c82"><xsl:value-of select="//tei:TEI[@xml:id='cart82']//tei:sourceDesc/tei:bibl/tei:title"/></button>
                </div>
                ...
                <div class="footer">
                    <div class="infoFooter" id="about">
                        <h2>About</h2>
                        <p> Il seguente progetto è stato realizzato per il corso di Codifica dei Testi (2021/2022) <br/>
                        <xsl:value-of select="//tei:respStmt[1]"/>. <br/> </p>
                    </div>
                    <div class="infoFooter" id="moreInfo">
                        <h2>More information</h2>
                        <p> Cartoline ubicate presso: <xsl:value-of select="//tei:msDesc/tei:msIdentifier/tei:repository"/> 
    ...
    <xsl:template match= "//tei:TEI[@xml:id='cart14' or @xml:id='cart23' or @xml:id='cart82']">
        <h3 class="titolocart"><xsl:value-of select="tei:teiHeader/tei:fileDesc/tei:sourceDesc/tei:bibl/tei:title"/> 
             (<xsl:value-of select="tei:teiHeader//tei:msDesc/tei:msIdentifier/tei:idno"/>)</h3>
        <div class="infoCartolina">
            ...
            <div class="boxInfo" id="infoFronte">
                <p><strong> Dimensioni: </strong>
                    ...
                    <xsl:value-of select="tei:teiHeader//tei:supportDesc/tei:support/tei:dimensions/tei:width"/> cm </p>
                <p><strong> Stato: </strong> 
                    <xsl:value-of select="tei:teiHeader//tei:supportDesc/tei:condition"/>
                </p>
                <p><strong> Lingue: </strong>
            ...
            <div class="boxInfo" id="infoRetro">
                <p>
                    <i><xsl:value-of select="tei:text//*[@type='postage_stamp']/tei:note" /></i>
                </p>
                <div class="divTesto">
                    <xsl:apply-templates select="tei:text//*[@type='testoMessaggio']" />
                </div><br />
                <div class="elemTipo">
                    <p><strong> Elementi tipografici: </strong>
                        <xsl:value-of select="tei:text//*[@type='codStampa']/tei:p" /><br />
